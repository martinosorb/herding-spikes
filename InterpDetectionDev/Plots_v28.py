...
for iii in range(len(Files)):
	...
	#Amplitudes
	SpkD_plot_v24.Rasterplot(HdfFile, FileName=PlotFile+'_Raster_amplitudes.png'\
	...
	###Scatterplot
	SpkD_plot_v24.Scatterplot(HdfFile, FileName=PlotFile+'_Scatter_repolarizing.png', FieldName='Amplitudes'\
	...
	###Densityplot
	SpkD_plot_v24.Densityplot(HdfFile, FileName=PlotFile+'_Density_repolarizing.png', FieldName=''\
	, xMin=0, xMax=64, yMin=0, yMax=64, cMin=10, cMax=10000, Res=8, logScale=True\
	, RepolSpikes=True, LongSpikes=False, ampThreshold=0, pThreshold=0, bgColor=pylab.cm.gray(0.5)\
	, SpikesCmap=pylab.cm.hot_r, alpha=1.)
	#Amplitudes
	SpkD_plot_v24.Densityplot(HdfFile, FileName=PlotFile+'_Density_amplitudes.png', FieldName='Amplitudes'\
