...
###This is an exazmple script that writes the .txt Files into a .hdf Files
# and estimates the spatial origins of spikes and marks events detected in multiple channels.
...
#--------------------------------------------------------------------
###Parameters BW_Chip_167_PT_Prep_12_11_30_Exp_24_12_2012_2500msec_burstActivity_insertedInserted
#which channels to remove
removeCh=0#-1: using a list from a file, 0: no removal, >0 cutoff frequency in Hz empty chip recording
#--------------------------------------------------------------------------
...
for iii in range(len(Files)):
	...
	NSpk=SpkD_v28.readSpikesFile(TxtFile, HdfFile, NoisyChFile, NCh, removeCh, tMax)
	SpkD_v28.readShapesFile(TxtFile, HdfFile, NSpk)
	SpkD_v28.IsolatedSpikes(HdfFile, IncludeLongSpikes=False, DFrames=3, MaxDist=1.)
