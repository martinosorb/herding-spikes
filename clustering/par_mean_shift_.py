...
def iterloop((my_mean,X,nbrs,bandwidth,stop_thresh,max_iter)):
...
def mean_shift(X, bandwidth=None, seeds=None, bin_seeding=False,
    ...
    pool = mp.Pool()
    all_res = pool.map_async(iterloop,((seed,X,nbrs,bandwidth,stop_thresh,max_iter) for seed in seeds))
    all_res = all_res.get()
